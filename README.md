...
Data: pandas, numpy, SQLAlchemy (SQL-Python integration)
ML: scikit-learn, XGBoost, statsmodels
Visualization: matplotlib, seaborn
Notebooks: Jupyter for interactive analysis and documentation

Repository Structure

projects/ — Completed analytical projects
notebooks/ — Analysis, exploration, and documentation
data/ — Sample datasets (public sources)
pipeline/ — Reusable data processing modules
...
Matthew Drew | Georgetown McDonough MSBA (Dec 2026) | LinkedIn